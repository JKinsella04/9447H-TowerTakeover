...
void pre_auton( void ) {
  // Since we are early in the season we do not have anything to do in the pre-auton phase before the match starts so we have no code here yet.
}


void autonomous( void ) {
  // Since we are early in the season we do not have any autonomous programs created to test since we do not have an exact robot design to base an autonomous off of.
}
